...
public class FileClass {
    public static void FileDestroyer(){
        ...
        f = new File("src/main/resources/configActionMarker.json");
        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckBlueOne.json");
        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckBlueThree.json");
        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckBlueTwo.json");

        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckGreenOne.json");
        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckGreenThree.json");
        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckGreenTwo.json");

        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckYellowOne.json");
        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckYellowThree.json");
        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckYellowTwo.json");

        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckVioletOne.json");
        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckVioletThree.json");
        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configDeckVioletTwo.json");
        if (f.exists())
            f.delete();

        f = new File("src/main/resources/configMarket.json");
        if (f.exists())
            f.delete();

...
public class DeckProductionCardTwoBlu extends DeckProductionCard {
    ...
    FileWriter configDeckBlueTwo= null;
    ...
    public DeckProductionCardTwoBlu(){
        ...
        try {
            ...
            configDeckBlueTwo= new FileWriter("src/main/resources/configDeckBlueTwo.json");
            configDeckBlueTwo.write(jsonStr);
            ...
            try {
                configDeckBlueTwo.flush();
                configDeckBlueTwo.close();
            } catch (IOException e) {
    ...
    public void saveInformationOfProductionDeck(){
        ...
        try {
            // Constructs a FileWriter given a file name, using the platform's default charset
            config = new FileWriter("src/main/resources/DeckProductionCardTwoBluLatest.json");
    ...
    public DeckProductionCardTwoBlu(ProductionCard[] deckRecover){
        ...
        try {
            ...
            // Constructs a FileWriter given a file name, using the platform's default charset
            configDeckBlueTwo = new FileWriter("src/main/resources/configDeckTwoBlu.json");
            configDeckBlueTwo .write(jsonStr);

...
public class DeckProductionCardOneViolet extends DeckProductionCard {
    ...
    public  DeckProductionCardOneViolet () throws IOException, InterruptedException {
        ...
        ProductionCard cardThree =new ProductionCard(violetThree,violetThreeIn,violetThreeOut, 3, 1, violet, 0, 27);
        deck.add(cardThree);
        ...
        ProductionCard cardSecond =new ProductionCard(violetFour,violetFourIn,violetFourOut, 4, 1, violet, 1, 28);
        deck.add(cardSecond);
     ...
     * this constructor creates all the production cards and adds them to the list and shuffles the newly created deck
     */
    public DeckProductionCardOneViolet(ProductionCard[] deckRecover) throws IOException, InterruptedException {
